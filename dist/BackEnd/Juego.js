...
class Juego {
    static agregarPersonaje(equipo, personaje) {
        ...
        if (equipo != 1 && equipo != 2)
            return; // Verifica si el equipo existe
    ...
    static iniciarJuego() {
        ...
        console.info(`Inicia el equipo ${equipoInicial} con el personaje ${this.personajeActual.nombre}`);
    ...
    static obtenerSiguientePersonaje() {
        ...
        if (debilitamiento) {
            ...
            const turnoActual = equipoActual === 1 ? this.turnoActualEquipo1 : this.turnoActualEquipo2;
...
Juego.equipo1 = [];
Juego.equipo2 = [];
Juego.turnoActualEquipo1 = 0;
Juego.turnoActualEquipo2 = 0;
Juego.turnoInicial = 0;
Juego.campoEfecto = []; // Por Ahora
Juego.equipoGanador = []; // Por ahora
// EQUIPO 1
